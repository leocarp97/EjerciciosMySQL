...
SELECT * FROM DEPARTAMENTOS WHERE NOT nombre_depto="Ventas" AND NOT nombre_depto="Mantenimiento" AND NOT nombre_depto="Investigacion";
...
SELECT nombre_depto, AVG(sal_emp)
...
/*Ejercicio 25 */
SELECT cod_director, nombre, count(id_emp)
FROM EMPLEADOS e, DEPARTAMENTOS d
WHERE e.id_emp=e.cod_jefe
GROUP BY cod_director
